...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        /**/ KC_Z        , KC_X        , LCTL_T(KC_C)  , LGUI_T(KC_V)              , LALT_T(KC_B)  ,/*              */ RALT_T(KC_N)      , RGUI_T(KC_M)   , RCTL(KC_COMM)  , KC_DOT      , KC_SLSH , /**/
    ...
    [_NAV] = LAYOUT(
        ...
        /**/ KC_TRNS           , KC_TRNS       , LCTL_T(KC_MEDIA_PREV_TRACK)  , LGUI_T(KC_MEDIA_PLAY_PAUSE), LALT_T(KC_MEDIA_NEXT_TRACK) ,/*          */ RALT_T(KC_N)      , RGUI_T(KC_M)   , RCTL(KC_COMM)  , KC_TRNS     , KC_TRNS , /**/
