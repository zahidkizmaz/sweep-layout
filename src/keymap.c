...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT(
        ...
        /**/ KC_ESC      , KC_TAB      , KC_GRV      , KC_DQUO          , KC_CAPS,/*       */ KC_MINUS   , KC_LPRN             , KC_RPRN           , KC_EQUAL   , KC_QUOTE ,/**/
        /**/ KC_LSFT     , TO(_NAV)    , KC_LCTL     , KC_LGUI          , KC_LALT,/*       */ KC_UNDS    , KC_LEFT_BRACKET     , KC_RIGHT_BRACKET  , KC_BSLS    , KC_RSFT  ,/**/
        /*------------------------------------------*/ TD(L_TAP)        , KC_SPC ,/*       */ KC_ENT     , KC_BSPC         /*-------------------------------------------------*/
                                                    /*----------------------------*/       /*-----------------------------*/
    ),
    ...
    [_BOARD] = LAYOUT(
        ...
        /**/ KC_NO       , KC_NO       , KC_NO       , KC_BTN1     , KC_BTN2     ,/*       */ KC_MS_L     , KC_MS_D     , KC_MS_U     , KC_MS_R     , KC_NO     ,/**/
